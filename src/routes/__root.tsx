...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "apple-mobile-web-app-title", content: "myVicRoads" },
      { property: "og:title", content: "myVicRoads" },
      { property: "og:description", content: "myVicRoads" },
...
function RootComponent() {
  ...
  return (
    <QueryClientProvider client={queryClient}>
      {isAdmin ? <Outlet /> : <AccessGate><Outlet /></AccessGate>}
    </QueryClientProvider>
  );
}
