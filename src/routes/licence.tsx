        ...
        <div>
          ...
          >
            <div className="relative flex w-full items-stretch justify-around">
              <div className="relative flex aspect-[4/5] w-[39%] items-center justify-center overflow-hidden rounded-lg bg-muted shadow-sm">
                {licence.photoUrl ? (
              ...
              <button
                ...
                className="relative flex aspect-[4/5] w-[39%] flex-col items-stretch rounded-lg bg-white p-3 text-center shadow-sm"
