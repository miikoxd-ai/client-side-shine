          ...
          >
            <div className="relative flex w-full items-stretch justify-around">
              <div className="relative flex aspect-[4/5] w-[45%] items-center justify-center overflow-hidden rounded-lg bg-muted shadow-sm">
                ...
                <img src={coatOfArmsOverlayImg} alt="" aria-hidden className="pointer-events-none absolute left-1 top-1 h-[80px] w-[80px] opacity-15" />
                <img src={coatOfArmsOverlayImg} alt="" aria-hidden className="pointer-events-none absolute bottom-1 left-1 h-[80px] w-[80px] opacity-15" />
                <img src={coatOfArmsOverlayImg} alt="" aria-hidden className="pointer-events-none absolute right-1 top-1/2 h-[80px] w-[80px] -translate-y-1/2 opacity-15" />
              </div>
              <button
